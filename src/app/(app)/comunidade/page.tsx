  ...
  const { data: tickets, error } = await supabase
    ...
    .select(
      `id, match_date, match_time, live_ended,
       ...
       picks!inner(id, selection, reason, status, bet_type, stage, odd, odd_min, entry_odd, entry_minute, alert_minute, category:bet_categories(name), pick_images(id, image_path))`
    )
